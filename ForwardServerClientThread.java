...
public class ForwardServerClientThread extends Thread
{
     ...
     */
    public ForwardServerClientThread(ServerSocket listensocket, String serverhost, int serverport,byte[] sessionKey, byte[] sessionIV) throws IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException
    {
    ...
    public void run() 
    {
        ...
        //	}
          ...
          /*  if(sessionEncrypter != null && sessionDecrypter != null) {
            ...
            if (mListenSocket == ServerHandshake.sessionSocket) { //server
                clientIn = sessionDecrypter.openCipherInputStream(clientIn);
                try {
					clientOut = sessionEncrypter.openCipherOutputStream(clientOut);
